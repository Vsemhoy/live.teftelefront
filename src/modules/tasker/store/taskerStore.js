...
export const useTaskerStore = create(
  persist(
    (set) => ({
      ...
      setCalendarMonth: (value) => set({ calendarMonth: value }),
      setCalendarMarkupMode: (value) => set({ calendarMarkupMode: value }),
      setCalendarMarkupTaskIds: (value) => set({ calendarMarkupTaskIds: value }),
      clearCalendarMarkup: () => set({ calendarMarkupTaskIds: [] }),
    ...
    }),
    {
      ...
      partialize: (state) => ({
        ...
        calendarMarkupMode: state.calendarMarkupMode,
        calendarMarkupTaskIds: state.calendarMarkupTaskIds,
      }),
    }
  )
);
