...
import { useAccounts, useCategories } from '../../api/ledgerApi';
import { formatMoney, calcDailyInterest, rateToStr } from '../../utils/ledgerUtils';
    ...
    <>
      <div className={sidebarClass}>
        ...
        <Stack gap={2} px={collapsed ? 4 : 8} pt={collapsed ? 8 : 4} pb={4} style={{ flexShrink: 0 }}>
          {[
            { path: '/ledger/timeline',   icon: IconTimeline, label: 'Timeline'   },
            { path: '/ledger/stats',      icon: IconChartBar, label: 'Stats'      },
            { path: '/ledger/categories', icon: IconTag,      label: 'Categories' },
