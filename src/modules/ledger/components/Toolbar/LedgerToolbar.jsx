...
export const LedgerToolbar = ({ visibleMonth, dragLocked, onToggleDragLock }) => {
  ...
  return (
    <div className="content-toolbar led-toolbar-grid">

      {/* Левый блок — текущий видимый месяц */}
      <div className="led-toolbar-month">
        {monthLabel && (
      ...
      <div className="led-toolbar-center">
      ...
      <div className="led-toolbar-lock">
