...
import { useCategories, useSaveCategory, useDeleteCategory } from '../../api/ledgerApi';
...
const CategoryNode = ({ node, onAdd, onSave, onDelete, depth = 0 }) => {
  ...
  return (
    <div className="led-cat-node" style={{ paddingLeft: depth * 20 }}>
      <div className="led-cat-row">
        {/* Экспандер */}
        <ActionIcon
        ...
        {!editing && (
          <Group gap={2} className="led-cat-actions" wrap="nowrap">
            {canAddChild && (
...
export const CategoryManager = () => {
  ...
  return (
    <div className="content-scroll" style={{ padding: '20px 24px', paddingBottom: 80 }}>
      ...
      <Stack gap={0} className="led-cat-tree">
        {/* Inline добавление корневой */}
        {addingRoot && (
          <div className="led-cat-node">
            <div className="led-cat-row">
              <span style={{ width: 20, flexShrink: 0 }} />
              <span style={{ flexShrink: 0, color: 'var(--mantine-color-green-5)' }}>
                <IconFolder size={14} />
